    ...
    <div className='productCard' >
      ...
      <div id="app" >
        <div id="player-1" class="player">
          <div class="wrapper">
            <img src="https://images.unsplash.com/photo-1557672172-298e090bd0f1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
              alt="Capa do CD do Hendrix Experience - Eyz Ryder" />
            <div class="info">
              <h1 class="title">Eyz Ryder</h1>
              <p>Jimi Hendrix</p>
            </div>
            <div class="controls">
              <div class="prev">
