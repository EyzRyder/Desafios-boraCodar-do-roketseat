  ...
  return (
    ...
    <div className="h-[350px] w-[300px] bg-[#0F0B16] transition-all hover:scale-[1.1] rounded p-3 my-4 relative shadow-md shadow-slate-700 hover:shadow-slate-300">
      ...
      <div className=" absolute bottom-[4%] left-[50%] translate-x-[-50%] flex gap-3">
        <Link to={`desafio/${url}`} className="bg-purple-700 py-2 px-3 flex justify-center items-center rounded-lg">
          Site
        </Link>
        <a href={rep} className="bg-purple-700 py-2 px-3 flex justify-center items-center rounded-lg">
          Repository
        </a>
      </div>
